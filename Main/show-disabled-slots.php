...
$sql="select * from adminslot where status='hide' ";
//echo $sql; die;	
...
<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<center><h1>Disabled Slots</h1></center>
		</div>
</div>
  ...
  <table class='table table-striped' style="font-size:20px;">
    ...
    <tbody>
		...
		while($row=mysqli_fetch_array($query))
		{
			...
			echo "<td>"?><a href="changestatus.php?statshow=<?=$row['admin_slot_id']?>"><i style="color:#000;" class="fas fa-eye"></i></a>
			<?php echo"</td>";
			echo "</tr>";
		} ?>    
