...
<form method="post" action="show-selected-slots-2.php">
	<div class="row">
		<div class="col-md-2"></div>
		<div class="col-md-8" style="padding-bottom:1rem;"> <h2 style="letter-spacing:0.1rem;"><strong> Select 	Date to show 'Selected Slots' </strong></h2></div>
    </div>
